...
<nav class="navbar navbar-expand-lg navbar-light bg-light  color: #aaa">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <form class="form-inline my-2 my-lg-0">
        <a href="{{ route('user.show', Auth::user()->id) }}" class="btn btn-outline-success my-2 my-sm-0">Back</a>
      </form>
      <form class="form-inline my-2 my-lg-0">
        {{-- <a href="{{ route('user.show', Auth::user()->id) }}" class="btn btn-outline-success my-2 my-sm-0">BACK</a> --}}
      </form>    
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="people-nearby">
                @foreach($suggestedFriends ?? '' as $suggestion)
                    <div class="nearby-user">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                <img src="{{ $suggestion->image }}" alt="user" class="profile-photo-lg">
                            </div>
                            <div class="col-md-7 col-sm-7">
                                <h5><a href="#" class="profile-link">{{ $suggestion->name }}</a></h5>
                            </div>
                            <div class="col-md-3 col-sm-3">
                                <form method="post" action="{{ route('friend-request.send', $suggestion->id) }}">
                                    @csrf
