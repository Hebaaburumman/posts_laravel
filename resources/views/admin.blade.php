				...
				<div class="row">
                   <div class="col-sm-6">
					...
					<div class="col-sm-6">
                        ...
                        <a href="{{ route('posts.show') }}" class="btn btn mr-2">Posts</a>
						<a href="{{ route('admin.users') }}" class="btn btn mr-2">Users</a>
...
@foreach ($posts as $post)
     <tr>
        <td>{{ $post->id }}</td>
        <td>{{ $post->name }}</td>
        <td> <img class="rounded-circle shadow-1-strong me-3" src="{{ asset($post->user->image) }}" alt="avatar" width="65" height="65" />
		</td>
