				...
				<div class="row">
                   <div class="col-sm-6">
					...
					<div class="col-sm-6">
                        ...
                        <a href="<?php echo e(route('posts.show')); ?>" class="btn btn mr-2">Posts</a>
						<a href="<?php echo e(route('admin.users')); ?>" class="btn btn mr-2">Users</a>
...
<?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <tr>
        ...
        <td> <img class="rounded-circle shadow-1-strong me-3" src="<?php echo e(asset($post->user->image)); ?>" alt="avatar" width="65" height="65" />
		</td>
        <td><?php echo e($post->description); ?></td>
        <td>
            <a href="<?php echo e(route('posts.edit', $post->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
            <form action="<?php echo e(route('posts.delete', $post->id)); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/file/posts/resources/views/admin.blade.php ENDPATH**/ ?>