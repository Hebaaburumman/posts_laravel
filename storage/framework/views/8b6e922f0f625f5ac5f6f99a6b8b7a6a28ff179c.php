...
<section class="background-radial-gradient overflow-hidden">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
          ...
          <div class="card bg-glass">
            ...
            <div class="card-body px-4 py-5 px-md-5">
                <form class="card" method="POST" action="<?php echo e(route('login.check')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                      ...
                      <button type="submit" class="btn btn-block btn-bold btn-primary">Login</button>
                      <a href="<?php echo e(route('register')); ?>" class="btn btn-block btn-bold btn-primary">Or Sign up Now</a>
  ...
  <!-- Section: Design Block --><?php /**PATH /var/www/file/posts/resources/views/login.blade.php ENDPATH**/ ?>