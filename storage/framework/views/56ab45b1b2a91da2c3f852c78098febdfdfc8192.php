            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                  ...
                  <form class="form-inline my-2 my-lg-0">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-success my-2 my-sm-0">Login</a>
                  </form>
...
<section class="background-radial-gradient overflow-hidden">
      ...
      <div class="row gx-lg-5 align-items-center mb-5">
        <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
          <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
            POSTS <br />
            <span style="color: hsl(218, 81%, 75%)">& COMMENTS</span>
          </h1>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
          ...
          <div class="card bg-glass">
            <div class="card-body px-4 py-5 px-md-5">
                <form class="card" method="POST" action="<?php echo e(route('register.store')); ?>">
  ...
  <!-- Section: Design Block --><?php /**PATH /var/www/file/posts/resources/views/signup.blade.php ENDPATH**/ ?>